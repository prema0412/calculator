...
var currentResult = ''; //function to display entered numbers on output panel
...
var displayInputs = function displayInputs(evnt) {
  ...
  console.log(previousResult); // displayNumber += enteredNumber
  // currentNumber = displayNumber
  // previousNUmber = displayNumber
  // previousResult = displayNumber

  var outPut = document.getElementById('display');
  outPut.innerHTML = displayNumber; // console.log(typeof(displayNumber))
...
var outPut = document.getElementById('display'); //Implementing clear and all clear function on click event

var clearOption = document.getElementById('clear');
clearOption.addEventListener('click', function () {
  if (clearOption.innerHTML == "AC") {
    displayNumber = 0;
    previousNUmber = '';
    previousResult = 0;
    currentNumber = ''; // console.log(previousNUmber);
  }

  if (clearOption.innerHTML == "C") {
    displayNumber = 0;
    outPut.innerHTML = displayNumber;
    clearOption.innerHTML = "AC"; // console.log(previousNUmber);
    // console.log(displayNumber);
